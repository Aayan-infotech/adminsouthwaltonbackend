...
//   const outputPath = path.join(__dirname, '..', 'utils', 'pdfAgreement.pdf');  // Adjusted to ensure the file extension is .pdf

//   // Ensure the file path is correct for PDF writing
