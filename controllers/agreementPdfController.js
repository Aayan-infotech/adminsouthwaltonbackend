...
const handleRentalAgreement = async (req, res) => {
  ...
  try {
      ...
      const paymentLink = `http://54.236.98.193:8133/Payment-admin?reserveAmount=${reserveAmount}&email=${encodeURIComponent(email)}&bookingId=${bookingId}&reservationId=${reservationId}`;
