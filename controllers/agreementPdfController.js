...
const handleRentalAgreement = async (req, res) => {
  ...
  try {
      ...
      const paymentLink = `http://44.196.64.110:5173/Payment-admin?reserveAmount=${reserveAmount}&email=${encodeURIComponent(email)}&bookingId=${bookingId}&reservationId=${reservationId}`;
